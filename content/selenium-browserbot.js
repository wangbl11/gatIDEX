...
BrowserBot.prototype.doesThisFrameMatchFrameExpression = function(
  ...
  var currentFrame = Components.utils.evalInSandbox(
    currentFrameString,
    mySandbox
  );
  //var currentFrame;
...
BrowserBot.prototype.findElement = function(locator, win) {
  ...
  if (element == null) {
    if (locator.includes("d-XPath")) {
      ...
      throw new SeleniumError(
        'The value "auto-located-by-tac" only can be automatically generated when recording a command'
      );
...
BrowserBot.prototype.locateElementByStoredReference = function(
  locator,
  document,
  window
) {
...
BrowserBot.prototype.locateElementByWebDriver = function(
  locator,
  document,
  window
) {
 ...
 */
BrowserBot.prototype.locateElementsByXPath = function(
  xpath,
  inDocument,
  inWindow
) {
...
BrowserBot.prototype.evaluateXPathCount = function(selector, inDocument) {
  ...
  var opts = {};
  opts["namespaceResolver"] = inDocument.createNSResolver
    ? inDocument.createNSResolver(inDocument.documentElement)
    : this._namespaceResolver;
...
BrowserBot.prototype.findAttribute = function(locator) {
  ...
  return goog.isDefAndNotNull(attributeValue)
